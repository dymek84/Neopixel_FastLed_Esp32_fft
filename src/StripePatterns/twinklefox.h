...
void drawTwinkles(uint8_t twinkleSpeed = 4, uint8_t twinkleDensity = 5)
{
    TWINKLE_SPEED = twinkleSpeed;
    TWINKLE_DENSITY = twinkleDensity;
    ...
    for (int i = 0; i < NUM_LEDS_STRIPE; i++)
    {
        ...
        else if (deltabright > 0)
        {
            ...
            stripe[i] = blend(bg, c, deltabright * 8);
        }
        else
        {
